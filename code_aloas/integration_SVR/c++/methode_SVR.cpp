...
#include <methode_SVR.h>

#define STOPFIRE ((Methode_SVR*) treatmentInstance->userdata)->stopFire
/*
 ...
 */
//#define METHODE_SVR_DATAS_FIELD1 ((TmtMethode_SVRData*)treatmentInstance->userdata)->field1
//#define METHODE_SVR_DATAS_FIELD2 ((TmtMethode_SVRData*)treatmentInstance->userdata)->field2
//#define METHODE_SVR_DATAS_FIELD3 ((TmtMethode_SVRData*)treatmentInstance->userdata)->field3
//#define METHODE_SVR_DATAS_FIELD4 ((TmtMethode_SVRData*)treatmentInstance->userdata)->field4
////etc...
/* 
...
void ALOAS_TMT_METHODE_SVR_API methode_SVR_preinitialize(TAlsTIStruct* treatmentInstance) {
    treatmentInstance->userdata = malloc(sizeof (Methode_SVR));
    STOPFIRE = false;
    /** \n <b> Structure de la fonction </b> : \li Début de la fonction */
     ...
     * Exemple :
     */
    // treatmentInstance->userdata = new TmtMethode_SVRData;
    // // Initialisation des champs de la structure
    // METHODE_SVR_DATAS_FIELD1 = 0;
    // METHODE_SVR_DATAS_FIELD2 = 0;
    // als_data_initializeDoubleBloc(&METHODE_SVR_DATAS_FIELD3);
    // als_data_initializeToken(&METHODE_SVR_DATAS_FIELD4, ADT_UNKNOWN);
...
void ALOAS_TMT_METHODE_SVR_API methode_SVR_fire(TAlsTIStruct* treatmentInstance) {
    ...
    IntBlock n_param, k_param, ns_param, ms_param, ds_param, wthres_param, Niter_param, itLim_param, N_recus_param;
    ...
    if (!STOPFIRE){
        ...
        if (als_ifc_getSampleCount(port_entree) >= n*num_rec  && !als_ifc_cancelled(treatmentInstance) ){
            ...
            if (als_data_upgradeTokenType(&bitEntree, ADT_BIT) == ACR_SUCCESS && bitEntree.bitBlock.size>=(n*num_rec)){
                ...
                Vector resultat= find_sparse_vector_SVR(motsRecus.rows,num_rec,n,k,ns,ms,d_s,w_thres,N_iter,itLim);
	            ...
	            ((Methode_SVR*) treatmentInstance->userdata)->stopFire = true;
     ...
     */
    // TmtMethode_SVRData userdata = *((TmtMethode_SVRData*) treatmentInstance->userdata);
    ...
    //  if (0 < als_ifc_getParameterBoolBlock(treatmentInstance, 0, &METHODE_SVR_DATAS_FIELD3)) {
    //    assert(METHODE_SVR_DATAS_FIELD3.size > 0);
    ...
    //     */
    //    outputComplexBlock.ptr_r[i] = METHODE_SVR_DATAS_FIELD3.ptr[0];
...
void ALOAS_TMT_METHODE_SVR_API methode_SVR_wrapup(TAlsTIStruct * treatmentInstance) {
    ...
    //  if (METHODE_SVR_DATAS_FIELD2 != 0) {
    //    free(METHODE_SVR_DATAS_FIELD2);
    //  }
    //  // Libération des blocs
    //  als_data_releaseDoubleBlock(&METHODE_SVR_DATAS_FIELD3);
    //  als_data_releaseToken(&METHODE_SVR_DATAS_FIELD4);
